...
// Csimple
double Csimple(NumericVector grid_x);
RcppExport SEXP _biweight_Csimple(SEXP grid_xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type grid_x(grid_xSEXP);
    rcpp_result_gen = Rcpp::wrap(Csimple(grid_x));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_biweight_Csimple", (DL_FUNC) &_biweight_Csimple, 1},
    {NULL, NULL, 0}
};
